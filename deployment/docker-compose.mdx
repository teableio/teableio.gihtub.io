...
Install teable with cloud or docker-compose
...
The Enterprise Edition offers free access to all features included in the Community Edition. It also supports the use of a License to subscribe to exclusive Enterprise features, which can be reviewed on the ~~pricing page~~. Data in the Enterprise Edition is compatible with the Community Edition, allowing for interchangeable switching between versions.
...
[Migrating from docker-standalone to Teable Enterprise](/deployment/migrating-from-docker-standalone-to-teable-enterprise)
...
[![](/images/deployment/button.svg)](https://railway.app/template/NtH5uD?referralCode=rE4BjB)

[![](/images/deployment/labring-actions/templates/main/Deploy-on-Sealos.svg)](https://cloud.sealos.io/?openapp=system-template%3FtemplateName%3Dteable)

> Sealos supports deployment in China

#### CE

[![](/images/deployment/button.svg)](https://railway.app/template/wada5e?referralCode=rE4BjB)

[![](/images/deployment/button.svg)](https://zeabur.com/templates/QF8695)

[![](/images/deployment/deploylobe.svg)](https://repocloud.io/details/?app_id=273)

[![](/images/deployment/logos%2Fdeploy-to-elestio-btn.png)](https://elest.io/open-source/teable)

### Next steps

[Configure email service](/deployment/docker-compose#qi-yong-you-jian-fu-wu)
...
[Configure external database connection for base](/deployment/docker-compose#qi-yong-wai-bu-shu-ju-ku-lian-jie-gong-neng)
...
![](/images/deployment/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FBhOqOioHyh1nx8Bso44d%252Fuploads%252FymL2SU1CqsIgSycuuExV%252Fimage.png)
...
[Environment variables table](/deployment/docker-compose#environment-variables)
...
[PreviousOpenID Connect](/developer/openid-connect)[NextEnvironment Variables](/deployment/environment-variables)
