...
![](/images/product/fields/field-type/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FBhOqOioHyh1nx8Bso44d%252Fuploads%252F2Dps1eMPWoLBVT5il6pF%252Fimage.png)
...
<CardGroup>
  <Card title="One-to-One" img="/images/product/fields/field-type/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FBhOqOioHyh1nx8Bso44d%252Fuploads%252FpWQTEoNExxEuXetci6VQ%252Fimage.png">
    Relationship
    ...
    An author and their unique autobiography.

    How to Create in Table A

    turn off "Allow linking to multiple records turn off "Allow symmetric field linking to multiple records"

    Screen shot
  </Card>

  <Card title="One-to-Many" img="/images/product/fields/field-type/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FBhOqOioHyh1nx8Bso44d%252Fuploads%252FR14z8vs8aHHuF9wR66UX%252Fimage.png">
    Relationship
    ...
    An author and their multiple books.

    How to Create in Table A

    turn on "Allow linking to multiple records turn off "Allow symmetric field linking to multiple records"
  ...
  <Card
    title="Many-to-One
（default)"
    img="/images/product/fields/field-type/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FBhOqOioHyh1nx8Bso44d%252Fuploads%252FH7SQRIhLdOEy80v5Vpdm%252Fimage.png"
  >
    Relationship

    Description

    Multiple records in Table A can be linked to one record in Table B.

    Example

    Multiple authors and a common publisher.

    How to Create in Table A

    turn off "Allow linking to multiple records turn on "Allow symmetric field linking to multiple records"

    Screen shot
  </Card>

  <Card title="Many-to-Many" img="/images/product/fields/field-type/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FBhOqOioHyh1nx8Bso44d%252Fuploads%252FtgWqbaeyG7ZJiVd4KcPT%252Fimage.png">
    Relationship

    Description

    Multiple records in Table A can be linked to multiple records in Table B.

    Example

    Multiple authors and multiple literary awards.

    How to Create in Table A

    turn on "Allow linking to multiple records turn on "Allow symmetric field linking to multiple records"
...
After setting up Link fields, we can proceed to more advanced lookup and rollup operations. They work together to provide powerful capabilities for automatic data retrieval and summarization calculations. For more details, see the sections on [Lookup](/product/fields/field-type/lookup) and [Rollup](/product/fields/field-type/rollup) fields.
...
[PreviousFunctions reference](/product/fields/field-type/formula/functions-reference)[NextLookup](/product/fields/field-type/lookup)
